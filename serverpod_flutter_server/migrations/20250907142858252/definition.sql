...
ALTER TABLE ONLY "games"
    ...
    FOREIGN KEY("currentWordId")
    REFERENCES "words"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "games"
    ADD CONSTRAINT "games_fk_1"
    FOREIGN KEY("nextWordId")
    REFERENCES "words"("id")
    ON DELETE NO ACTION
    ON UPDATE NO ACTION;
ALTER TABLE ONLY "games"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('serverpod_flutter', '20250907142858252', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20250907142858252', "timestamp" = now();
